...
import {
  ...
  AdapterSourceTypeSchema as SourceTypeSchema,
} from "./adapter-manifest.js";
import {
  ProvenanceV2AdapterReceiptSchema,
  ProvenanceV2AuthorityRootRegistrySchema,
  ProvenanceV2AuthorityRootVectorsSchema,
  ProvenanceV2FieldCorpusSchema,
...
export * from "./provenance-v2-connected-registration-document.js";
...
export const GENERATED_SCHEMAS = {
  ...
  ProvenanceV2ConnectedRegistrationGraph:
    ProvenanceV2ConnectedRegistrationGraphSchema,
  ProvenanceV2ConnectedDocumentCascadeVectors:
