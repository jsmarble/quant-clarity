...
| `GATE-restore-and-rebuild` | `DIT-BE-010`, `DIT-BE-011`, `DIT-BE-012`, `PIT-PIPE-053`, `ORT-OPS-006`, `ORT-OPS-008` | Fresh isolated environment, logical base-table/R2 backup, no existing FTS/Vectorize state | Canonical/public data restore ≤24h; FTS and Vectorize rebuild; hashes/evidence links/search probes match | Restore transcript, manifests, timings | Operations |
