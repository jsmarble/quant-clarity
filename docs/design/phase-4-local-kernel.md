...
- The initial serving provider-slice table cannot represent an unavailable provider without minting a fictitious non-null slice ID. Runtime persistence remains pending the ADR 0015 closed-disposition migration and contract update.
