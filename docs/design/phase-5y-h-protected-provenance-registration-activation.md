...
| Field | Value |
|---|---|
| Status | Proposed; review-candidate registration/root/field artifacts, typed root-binding plan and independent codec vectors locally implemented; normative contract, accepted limits, migration and activation evidence pending |
