...
| Field | Value |
|---|---|
| Status | Proposed; review-candidate registration/root/field artifacts, typed root-binding plan, independent codec vectors and Phase 5Y-H1 family-projection/frame-composition evidence locally implemented; connected traversal, normative resolver/semantic contract, accepted limits, migration and activation evidence pending |
