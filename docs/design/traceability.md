...
| `PIPE-044` | §12 | Validation failures shall never publish partial malformed records or erase the last known good dataset. | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-044`; [local kernel evidence](phase-3-local-kernels.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md) | Planned |
...
| `PIPE-050` | §12 | Canonical publication shall be versioned and atomic from a public reader’s perspective. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-050`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md) | Planned |
| `PIPE-051` | §12 | Model/provider data and search indexes shall not expose incompatible dataset versions during a rollout. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-051`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md) | Planned |
| `PIPE-052` | §12 | The most recent known-good publication shall remain available while a new run is processing or quarantined. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-052`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md) | Planned |
...
| `QA-006` | §21 | Publication tests shall prove that failed or partial runs cannot replace the last known-good dataset. | `D16`, `D19` | Quality-gate audit — `QGA-QA-006`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md) | Planned |
