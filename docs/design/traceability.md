...
| `PIPE-003` | §12 | A scheduled run shall create an immutable run identifier and record its scheduled time, actual start/end,… | `D08`, `D12`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-003` | Planned |
| `PIPE-004` | §12 | Concurrent runs for the same provider shall be prevented or made safely idempotent. | `D08`, `D12`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-004` | Planned |
| `PIPE-005` | §12 | Provider failures shall be isolated so one provider cannot prevent successful providers from publishing. | `D08`, `D12`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-005` | Planned |
...
| `PIPE-031` | §12 | Prompts shall include only the minimum source content required and shall treat retrieved content as… | `D07`, `D12`, `D13`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-031` | Planned |
...
| `PIPE-040` | §12 | Validation shall check identifiers, enum values, decimal prices, currency codes, price units, parameter… | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-040` | Planned |
| `PIPE-041` | §12 | A price change above an operator-configured percentage, precision downgrade/upgrade, model disappearance,… | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-041` | Planned |
| `PIPE-042` | §12 | Anomalies shall be automatically re-retrieved from the source before acceptance. | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-042` | Planned |
| `PIPE-043` | §12 | If automated re-verification cannot resolve an anomaly, only the affected records shall be quarantined; the… | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-043` | Planned |
| `PIPE-044` | §12 | Validation failures shall never publish partial malformed records or erase the last known good dataset. | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-044` | Planned |
| `PIPE-045` | §12 | The pipeline shall provide machine-readable run reports suitable for private operator issue creation or task… | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-045` | Planned |
