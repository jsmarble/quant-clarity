...
| `RULE-017` | §8.2 | Affiliate availability, commission value, and operator preference shall not influence default order,… | `D05`, `D10`, `D11`, `D19` | Unit/golden — `UT-RULE-017`; [ADR 0021 provider-search neutrality](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `FE-023` | §9.3 | A model card shall not show provider names, provider prices, provider-serving precision, provider… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-023`; [ADR 0021 no provider-name model fan-out](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E separate provider projection](phase-4e-provider-search-core.md); [locally implemented Phase 5G-B canonical-only result](phase-5g-b-model-variant-exact-reader.md) | Planned |
...
| `FE-025` | §9.3 | Provider filters may determine whether a model card is included in results, but shall not change the card’s… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-025`; [ADR 0021 filter/search separation](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E projection isolation tests](phase-4e-provider-search-core.md); [locally implemented Phase 5G-B provider-free candidate](phase-5g-b-model-variant-exact-reader.md) | Planned |
| `FE-026` | §9.3 | Applying or removing a provider filter shall not introduce a provider-derived boost or secondary order among… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-026`; [ADR 0021 neutral merge order](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E neutral projection ordering](phase-4e-provider-search-core.md); [locally implemented Phase 5G-B stable-ID collision order](phase-5g-b-model-variant-exact-reader.md) | Planned |
...
| `SRCH-002` | §10 | Exact canonical model names, exact provider model IDs, and exact provider names shall appear before… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-002`; [Phase 4D1 FTS fields and provider-name gap](phase-4d1-readiness-ledger.md); [ADR 0021 provider-name decision](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E trusted provider projection](phase-4e-provider-search-core.md); [Phase 4G durable provider index](phase-4g-provider-search-schema-writers.md); [Phase 5B internal provider exact reader](phase-5b-provider-exact-name-reader.md); [Phase 5C NUL boundary](phase-5c-provider-name-nul-boundary.md); [Phase 5D local RPC provider tier](phase-5d-local-query-rpc.md); [ADR 0025 trusted model/variant canonical-name decision](../decisions/0025-trusted-model-variant-name-projection.md); [Phase 5F implemented trusted model/variant projection core](phase-5f-model-variant-name-projection-core.md); [ADR 0026 BLOB/cutover decision](../decisions/0026-blob-model-variant-exact-search-cutover.md); [implemented Phase 5G-A1 storage-proof core](phase-5g-a1-model-variant-durable-proof-core.md); [implemented Phase 5G-A2 durable model/variant tier](phase-5g-a2-model-variant-search-cutover.md); [locally implemented Phase 5G-B exact reader/RPC](phase-5g-b-model-variant-exact-reader.md), provider-model-ID tier and public composition pending | Planned |
...
| `API-003` | §11.1 | API data shall be the same canonical published data used by the website. | `D09`, `D16`, `D19` | API conformance — `ACT-API-003`; ADR 0013 contract; [Phase 4 local selection decision](phase-4-local-kernel.md); [Phase 4C sealed identity](phase-4c-sealed-closure.md); [Phase 4D2 exact head identity](phase-4d2-exact-generation-switching.md); [Phase 5B hot-publication canonical provider reads](phase-5b-provider-exact-name-reader.md); [Phase 5D local query-RPC and adapter seams](phase-5d-local-query-rpc.md); [locally implemented Phase 5G-B canonical model/variant read seam](phase-5g-b-model-variant-exact-reader.md), service binding/public transport pending | Planned |
| `API-004` | §11.1 | Responses shall use JSON and UTF-8, with documented field types, units, enums, null behavior, and timestamps. | `D09`, `D16`, `D19` | API conformance — `ACT-API-004`; [Phase 5E required degradation type/null/default semantics](phase-5e-search-collection-degradation.md) | Planned |
...
| `API-007` | §11.1 | Every collection shall use deterministic cursor pagination and enforce a documented maximum page size. | `D09`, `D16`, `D19` | API conformance — `ACT-API-007`; [Phase 5D exact/public cursor-tuple blocker](phase-5d-local-query-rpc.md); [locally implemented Phase 5G-B tier-local keyset/non-cursor boundary](phase-5g-b-model-variant-exact-reader.md), merged public cursor pending | Planned |
...
| `API-009` | §11.1 | Sorting shall use an explicit allowlist and neutral deterministic secondary keys such as provider display… | `D09`, `D16`, `D19` | API conformance — `ACT-API-009`; [locally implemented Phase 5G-B stable-ID collision order](phase-5g-b-model-variant-exact-reader.md) | Planned |
| `API-010` | §11.1 | The API shall expose search with the same exact-first behavior and structured filters as the web interface. | `D09`, `D16`, `D19` | API conformance — `ACT-API-010`; [Phase 5D local provider tier and incomplete-search blocker](phase-5d-local-query-rpc.md); [Phase 5E collection degradation representation](phase-5e-search-collection-degradation.md); [locally implemented Phase 5G-B model/variant exact seam](phase-5g-b-model-variant-exact-reader.md), public multi-tier/filter composition pending | Planned |
...
| `API-014` | §11.1 | The API shall publish an OpenAPI description and human-readable examples. | `D09`, `D16`, `D19` | API conformance — `ACT-API-014`; [Phase 5E empty degraded-search example](phase-5e-search-collection-degradation.md), complete route examples pending | Planned |
| `API-015` | §11.1 | A metadata endpoint shall expose dataset version, schema version, methodology version, publication time, and… | `D09`, `D16`, `D19` | API conformance — `ACT-API-015`; [Phase 4D2 normalized-head source](phase-4d2-exact-generation-switching.md), endpoint pending | Planned |
| `API-016` | §11.1 | Additive response fields and new enum values shall be backward-compatible within a major API version; API… | `D09`, `D16`, `D19` | API conformance — `ACT-API-016`; [Phase 5E recursive unknown tolerance and additive mirror policy](phase-5e-search-collection-degradation.md) | Planned |
| `API-017` | §11.1 | Removing or changing field semantics shall require a new major API version or a published deprecation period… | `D09`, `D16`, `D19` | API conformance — `ACT-API-017`; [Phase 5E retained `/v1` result mirror](phase-5e-search-collection-degradation.md) | Planned |
...
| `BE-008` | §13 | Provider source APIs shall never be called synchronously on behalf of a public page or API request. Public… | `D04`, `D05`, `D08`, `D09`, `D14`, `D16`, `D19` | Data integration — `DIT-BE-008`; [Phase 5B publication-only reader](phase-5b-provider-exact-name-reader.md); [locally implemented Phase 5G-B publication-only reader](phase-5g-b-model-variant-exact-reader.md) | Planned |
...
[Phase 5A](phase-5a-local-api-kernel.md) contributes local negative-capability and bounds targets to `SEC-001`, `SEC-007`, and `SEC-011`; locally implemented [Phase 5G-B](phase-5g-b-model-variant-exact-reader.md) adds the fixed SELECT-only, bounded, static-error acceptance boundary. Deployed penetration, platform-limit, and zero-visitor-data evidence remains required and the rows stay `Planned`.

| Source ID | PRD | Requirement summary | Planned design sections | Planned primary verification | Status |
|---|---|---|---|---|---|
| `SEC-001` | §17 | The public Worker shall expose no data mutation, pipeline trigger, credential validation, or privileged… | `D03`, `D06`, `D07`, `D09`, `D12`, `D13`, `D16`, `D19` | Security — `SST-SEC-001`; [Phase 5B fixed SELECT-only source proof](phase-5b-provider-exact-name-reader.md); [locally implemented Phase 5G-B fixed SELECT-only source](phase-5g-b-model-variant-exact-reader.md) | Planned |
...
| `PRIV-007` | §18.1 | Privacy by design/default and a blocking zero-visitor-data gate | `D12`, `D13`, `D16`, `D19` | Privacy — `PVT-PRIV-007`; [ADR 0021 provider-search privacy boundary](../decisions/0021-canonical-provider-exact-search.md); [Phase 5B zero-data reader boundary](phase-5b-provider-exact-name-reader.md); [locally implemented Phase 5G-B zero-data acceptance](phase-5g-b-model-variant-exact-reader.md) | Planned |
...
| `QA-004` | §21 | API conformance tests shall validate OpenAPI examples, pagination, filters, sorting, caching, CORS, nulls,… | `D16`, `D19` | Quality-gate audit — `QGA-QA-004`; [Phase 5D local RPC adapter boundary](phase-5d-local-query-rpc.md); [Phase 5E empty-response OpenAPI validation](phase-5e-search-collection-degradation.md); [locally implemented Phase 5G-B internal API seam tests](phase-5g-b-model-variant-exact-reader.md), public conformance pending | Planned |
| `QA-005` | §21 | Search tests shall cover exact IDs, aliases, provider names, precision phrases, natural-language intent,… | `D16`, `D19` | Quality-gate audit — `QGA-QA-005`; [ADR 0021 provider-name validation matrix](../decisions/0021-canonical-provider-exact-search.md); [Phase 5B focused exact-provider tests](phase-5b-provider-exact-name-reader.md); [Phase 5C U+0000 boundary matrix](phase-5c-provider-name-nul-boundary.md); [Phase 5D bookmark-continuous provider tier](phase-5d-local-query-rpc.md); [Phase 5E empty degraded-result and equality contract](phase-5e-search-collection-degradation.md); [ADR 0025 canonical model/variant derivation matrix](../decisions/0025-trusted-model-variant-name-projection.md); [Phase 5F implemented trusted-projection tests](phase-5f-model-variant-name-projection-core.md); [locally implemented Phase 5G-B reader/RPC acceptance](phase-5g-b-model-variant-exact-reader.md), full search set pending | Planned |
| `QA-006` | §21 | Publication tests shall prove that failed or partial runs cannot replace the last known-good dataset. | `D16`, `D19` | Quality-gate audit — `QGA-QA-006`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C seal/head-fence tests](phase-4c-sealed-closure.md); [Phase 4D1 FTS/receipt rollback](phase-4d1-readiness-ledger.md); [Phase 4D2 exact-generation failure injection](phase-4d2-exact-generation-switching.md); [Phase 4D3 D1 adapter reconciliation](phase-4d3-fixed-d1-switch-adapter.md); [Phase 4D4 all-statement rollback](phase-4d4-fixed-d1-readiness-adapter.md); [ADR 0021 provider-index corruption matrix](../decisions/0021-canonical-provider-exact-search.md); [Phase 4G SQLite/workerd failure evidence](phase-4g-provider-search-schema-writers.md); [Phase 5B hot-publication workerd reader](phase-5b-provider-exact-name-reader.md); [Phase 5C fail-closed migration plan](phase-5c-provider-name-nul-boundary.md); [Phase 5D switch/rollback bookmark-read boundary](phase-5d-local-query-rpc.md) | Planned |
