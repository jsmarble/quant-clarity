...
| `FE-010` | §9.2 | The home page shall center a model-first search control that supports canonical names, aliases, publisher… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-010`; [ADR 0021 canonical provider result](../decisions/0021-canonical-provider-exact-search.md) | Planned |
| `FE-011` | §9.2 | Search suggestions shall distinguish models, explicit variants, and providers before selection. | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-011`; [ADR 0021 distinct provider suggestion](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `FE-013` | §9.2 | Initial results shall prioritize exact and prefix model-name matches before semantic matches. | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-013`; [ADR 0021 fixed exact tiers](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `FE-023` | §9.3 | A model card shall not show provider names, provider prices, provider-serving precision, provider… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-023`; [ADR 0021 no provider-name model fan-out](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E separate provider projection](phase-4e-provider-search-core.md) | Planned |
...
| `FE-025` | §9.3 | Provider filters may determine whether a model card is included in results, but shall not change the card’s… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-025`; [ADR 0021 filter/search separation](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E projection isolation tests](phase-4e-provider-search-core.md) | Planned |
| `FE-026` | §9.3 | Applying or removing a provider filter shall not introduce a provider-derived boost or secondary order among… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-026`; [ADR 0021 neutral merge order](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E neutral projection ordering](phase-4e-provider-search-core.md) | Planned |
...
| `API-007` | §11.1 | Every collection shall use deterministic cursor pagination and enforce a documented maximum page size. | `D09`, `D16`, `D19` | API conformance — `ACT-API-007`; [Phase 5D exact/public cursor-tuple blocker](phase-5d-local-query-rpc.md) | Planned |
...
[ADR 0026](../decisions/0026-blob-model-variant-exact-search-cutover.md) and implemented [Phases 5G-A1](phase-5g-a1-model-variant-durable-proof-core.md) and [5G-A2](phase-5g-a2-model-variant-search-cutover.md) contribute controlled-writer and reconstructible-search boundaries to `BE-003` and `BE-010`–`BE-012`. A2's local backup-v1 source-profile transform and rebuild coordinator are expressly not the writer-drained exporter, full importer, migration-away path, RPO/RTO exercise, or deployed restore. Remote durable writing, portable operational restore, migration-away export, reader rehydration, and deployment remain pending, so no backend row advances.
...
| `BE-008` | §13 | Provider source APIs shall never be called synchronously on behalf of a public page or API request. Public… | `D04`, `D05`, `D08`, `D09`, `D14`, `D16`, `D19` | Data integration — `DIT-BE-008`; [Phase 5B publication-only reader](phase-5b-provider-exact-name-reader.md) | Planned |
...
| Source ID | PRD | Requirement summary | Planned design sections | Planned primary verification | Status |
|---|---|---|---|---|---|
| `SEC-001` | §17 | The public Worker shall expose no data mutation, pipeline trigger, credential validation, or privileged… | `D03`, `D06`, `D07`, `D09`, `D12`, `D13`, `D16`, `D19` | Security — `SST-SEC-001`; [Phase 5B fixed SELECT-only source proof](phase-5b-provider-exact-name-reader.md) | Planned |
...
| `SEC-007` | §17 | API query length, filter count, page size, semantic-search cost, and response size shall have explicit bounds. | `D03`, `D06`, `D07`, `D09`, `D12`, `D13`, `D16`, `D19` | Security — `SST-SEC-007`; [Phase 5B input/page/row/aggregate bounds](phase-5b-provider-exact-name-reader.md); [Phase 5C pre-D1 NUL rejection](phase-5c-provider-name-nul-boundary.md) | Planned |
...
| `PRIV-006` | §18.1 | No raw visitor input retention; only path-only canonical detail caching by publication and stable ID | `D09`, `D11`, `D13`, `D16`, `D19` | Privacy — `PVT-PRIV-006`; ADR 0013 local helpers; [ADR 0021 transient exact lookup](../decisions/0021-canonical-provider-exact-search.md); [Phase 5B transient no-cache reader](phase-5b-provider-exact-name-reader.md); [Phase 5E query-free degradation metadata and no-store boundary](phase-5e-search-collection-degradation.md) | Planned |
| `PRIV-007` | §18.1 | Privacy by design/default and a blocking zero-visitor-data gate | `D12`, `D13`, `D16`, `D19` | Privacy — `PVT-PRIV-007`; [ADR 0021 provider-search privacy boundary](../decisions/0021-canonical-provider-exact-search.md); [Phase 5B zero-data reader boundary](phase-5b-provider-exact-name-reader.md) | Planned |
...
| `PRIV-011` | §18.1 | Synthetic-only public monitoring; non-visitor control-plane observability | `D12`, `D13`, `D14`, `D16`, `D19` | Privacy — `PVT-PRIV-011`; [ADR 0021 synthetic-only query probes](../decisions/0021-canonical-provider-exact-search.md); [Phase 5B no-telemetry reader](phase-5b-provider-exact-name-reader.md) | Planned |
