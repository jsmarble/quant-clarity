...
[Phase 5A](phase-5a-local-api-kernel.md) records bounded local decision targets for `SRCH-002`, `SRCH-004`–`SRCH-006`, `SRCH-008`, and `SRCH-009`. [Phase 5B](phase-5b-provider-exact-name-reader.md) adds a selected-publication lifecycle recheck and canonical-rehydrating provider exact-name D1 reader, and records the unresolved NUL/storage mismatch. Both slices deliberately omit public search integration and leave every search row `Planned` pending the complete acceptance set and deployed search evidence.
...
| `SRCH-002` | §10 | Exact canonical model names, exact provider model IDs, and exact provider names shall appear before… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-002`; [Phase 4D1 FTS fields and provider-name gap](phase-4d1-readiness-ledger.md); [ADR 0021 provider-name decision](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E trusted provider projection](phase-4e-provider-search-core.md); [Phase 4G durable provider index](phase-4g-provider-search-schema-writers.md); [Phase 5B internal provider exact reader](phase-5b-provider-exact-name-reader.md), other tiers/public query pending | Planned |
...
| `SRCH-006` | §10 | Search index records shall reference stable canonical IDs; canonical facts shall be fetched from the… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-006`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4C sealed inventory](phase-4c-sealed-closure.md); [Phase 4D1 FTS parity](phase-4d1-readiness-ledger.md); [ADR 0021 provider rehydration](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E manifest/resource binding](phase-4e-provider-search-core.md); [Phase 4G source/FTS parity](phase-4g-provider-search-schema-writers.md); [Phase 5B canonical provider rehydration](phase-5b-provider-exact-name-reader.md) | Planned |
...
| `SEC-007` | §17 | API query length, filter count, page size, semantic-search cost, and response size shall have explicit bounds. | `D03`, `D06`, `D07`, `D09`, `D12`, `D13`, `D16`, `D19` | Security — `SST-SEC-007`; [Phase 5B input/page/row/aggregate bounds](phase-5b-provider-exact-name-reader.md) | Planned |
