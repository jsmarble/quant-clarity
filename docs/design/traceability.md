...
[Phase 5A](phase-5a-local-api-kernel.md) records bounded local decision targets for `SRCH-002`, `SRCH-004`–`SRCH-006`, `SRCH-008`, and `SRCH-009`. [Phase 5B](phase-5b-provider-exact-name-reader.md) adds a selected-publication lifecycle recheck and canonical-rehydrating provider exact-name D1 reader. [ADR 0022](../decisions/0022-forbid-nul-provider-display-names.md) and [Phase 5C](phase-5c-provider-name-nul-boundary.md) resolve its U+0000 contract/storage design mismatch without changing normalization version 1. These slices deliberately omit public search integration and leave every search row `Planned` pending the complete acceptance set and deployed search evidence.
...
| `SRCH-002` | §10 | Exact canonical model names, exact provider model IDs, and exact provider names shall appear before… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-002`; [Phase 4D1 FTS fields and provider-name gap](phase-4d1-readiness-ledger.md); [ADR 0021 provider-name decision](../decisions/0021-canonical-provider-exact-search.md); [Phase 4E trusted provider projection](phase-4e-provider-search-core.md); [Phase 4G durable provider index](phase-4g-provider-search-schema-writers.md); [Phase 5B internal provider exact reader](phase-5b-provider-exact-name-reader.md); [Phase 5C NUL boundary](phase-5c-provider-name-nul-boundary.md), other tiers/public query pending | Planned |
...
| `SRCH-008` | §10 | Deleted or inactive records shall be removed from default search results without destroying their historical… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-008`; [Phase 5B default active-only provider reader](phase-5b-provider-exact-name-reader.md), historical/status policy pending | Planned |
