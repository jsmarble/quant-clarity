...
| `SRCH-006` | §10 | Search index records shall reference stable canonical IDs; canonical facts shall be fetched from the… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-006`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4C sealed inventory](phase-4c-sealed-closure.md) | Planned |
| `SRCH-007` | §10 | A data publication shall not be considered complete until corresponding search-index changes are queryable… | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-007`; [Phase 4 local readiness decision](phase-4-local-kernel.md); [Phase 4C readiness fence](phase-4c-sealed-closure.md), Vectorize evidence pending | Planned |
...
| `PIPE-044` | §12 | Validation failures shall never publish partial malformed records or erase the last known good dataset. | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-044`; [local kernel evidence](phase-3-local-kernels.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C seal-CAS evidence](phase-4c-sealed-closure.md) | Planned |
...
| `BE-011` | §13 | Search indexes shall be reproducible from canonical publication data and shall not be the sole store of any… | `D04`, `D05`, `D08`, `D09`, `D14`, `D16`, `D19` | Data integration — `DIT-BE-011`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4C portable vector/chunk inventory](phase-4c-sealed-closure.md) | Planned |
