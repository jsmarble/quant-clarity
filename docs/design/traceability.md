...
| `API-003` | §11.1 | API data shall be the same canonical published data used by the website. | `D09`, `D16`, `D19` | API conformance — `ACT-API-003`; ADR 0013 contract; [Phase 4 local selection decision](phase-4-local-kernel.md); [Phase 4C sealed identity](phase-4c-sealed-closure.md), public transport pending | Planned |
...
| `PIPE-044` | §12 | Validation failures shall never publish partial malformed records or erase the last known good dataset. | `D07`, `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-044`; [local kernel evidence](phase-3-local-kernels.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C seal-CAS evidence](phase-4c-sealed-closure.md); [Phase 4D1 receipt rollback](phase-4d1-readiness-ledger.md) | Planned |
...
| `PIPE-050` | §12 | Canonical publication shall be versioned and atomic from a public reader’s perspective. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-050`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C sealed persistence](phase-4c-sealed-closure.md); [Phase 4D1 readiness transaction](phase-4d1-readiness-ledger.md) | Planned |
| `PIPE-051` | §12 | Model/provider data and search indexes shall not expose incompatible dataset versions during a rollout. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-051`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C closed inventory](phase-4c-sealed-closure.md); [Phase 4D1 FTS/receipt binding](phase-4d1-readiness-ledger.md) | Planned |
| `PIPE-052` | §12 | The most recent known-good publication shall remain available while a new run is processing or quarantined. | `D08`, `D14`, `D16`, `D19` | Pipeline integration — `PIT-PIPE-052`; [Phase 4 local evidence](phase-4-local-kernel.md); [Phase 4B persistence evidence](phase-4b-serving-dispositions.md); [Phase 4C readiness/head fence](phase-4c-sealed-closure.md); [Phase 4D1 closed-head evidence](phase-4d1-readiness-ledger.md) | Planned |
...
| `BE-003` | §13 | All write operations shall originate from controlled pipeline/deployment identities; the public Worker API… | `D04`, `D05`, `D08`, `D09`, `D14`, `D16`, `D19` | Data integration — `DIT-BE-003`; [Phase 4D1 controlled-writer boundary](phase-4d1-readiness-ledger.md), binding proof pending | Planned |
