...
| `FE-023` | §9.3 | A model card shall not show provider names, provider prices, provider-serving precision, provider… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-023`; [ADR 0021 no provider-name model fan-out](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `FE-025` | §9.3 | Provider filters may determine whether a model card is included in results, but shall not change the card’s… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-025`; [ADR 0021 filter/search separation](../decisions/0021-canonical-provider-exact-search.md) | Planned |
| `FE-026` | §9.3 | Applying or removing a provider filter shall not introduce a provider-derived boost or secondary order among… | `D11`, `D16`, `D19` | End-to-end/accessibility — `E2E-FE-026`; [ADR 0021 neutral merge order](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `SRCH-009` | §10 | Search shall tolerate common punctuation, case, separator, and organization-prefix differences. | `D10`, `D16`, `D19` | Search acceptance — `SAT-SRCH-009`; [ADR 0021 pinned exact normalization](../decisions/0021-canonical-provider-exact-search.md) | Planned |
...
| `AFF-004` | §18.2 | Affiliate availability, expected commission, or rate shall not affect inclusion, search relevance,… | `D03`, `D11`, `D13`, `D16`, `D19` | Affiliate neutrality — `ANT-AFF-004`; [ADR 0021 excludes affiliate inputs](../decisions/0021-canonical-provider-exact-search.md) | Planned |
