...
[Phase 5Y-H2d-b](phase-5y-h2d-b-connected-registration-document.md) supplies the schema-valid canonical synthetic document, independently executes every actual H2a safe-preimage occurrence, reconstructs retained chunks, and proves whole/chunk hashes and the document-count inventory. [Phase 5Y-H2d-c](phase-5y-h2d-c-connected-document-cascade.md) now overlays those results onto the H2a graph and regenerates the dependent successor, leaf/root, document and refused cascade. External approved-row and repository-artifact anchors, document-output/semantic parity, a reviewed build manifest, the complete semantic oracle, migration 0010, frozen D1 enumeration, accepted aggregate limits and protected writers remain later gates.
