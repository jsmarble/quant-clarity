...
Status: implementation in progress; B3-A admission and pre-open audit plus pure, unrouted B3-B Model-detail planning/rendering and staged publication/read authority implemented locally; protected audit invocation/evidence, recovery admission, public routing, limiter integration, and manual-cache increments pending
