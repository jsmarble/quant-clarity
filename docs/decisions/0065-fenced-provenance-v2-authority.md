...
1. Implement exact-predecessor capability, empty installation identity, and dormant authority-plan/bundle/permit/response shapes with unconditional approval/open/permit/response/effect blockers and refusal tests.
2. Add protected normalized source/policy/adapter-manifest registration, independent roots, plan approval, and guarded bundle opening.
