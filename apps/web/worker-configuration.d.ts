/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2dad2fb66889540bd554cfc335e9ede)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 nodejs_compat,nodejs_compat_do_not_populate_process_env
interface __BaseEnv_Env {
	READ_LIMITER: RateLimit;
	ROTATION_LIMITER: RateLimit;
	ASSETS: Fetcher;
	DEPLOYMENT_ENV: "local";
	API: Fetcher /* quant-clarity-api-local */;
}
